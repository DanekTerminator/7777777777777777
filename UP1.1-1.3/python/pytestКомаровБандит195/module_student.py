...
class Department:
    ...
    def __str__(self):
        return f"Группа 195: {self.title}, Главарь банды: Гришакова Татьяна Николаевна, Количество студентов: {len(self.employees)} "
...
emp_1 = Student(1, 'Комаров Данила Алексеевич', '11.08.2006', 530)
emp_2 = Student(2, 'Рудаков Михаил Сергеевич', '12.04.2001', 0)
